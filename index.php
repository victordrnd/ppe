          ...
          <div class="col-md-6">
            <div class="card mt-2 mt-md-4 border-0 shadow-small card-top">
              ...
              <div class="card-block p-3">
                <h5 class="card-title">D&eacute;couvrez Google Home.</h5>
          ...
          <div class="col-md-6">
            <div class="card mt-2 mt-md-4 border-0 shadow-small card-top">
              ...
              <div class="card-block p-3">
                ...
                <p class="card-text text-truncate">Ressentez la musique avec une puissance, une nettet&eacute; et une clart&eacute; jamais atteintes.</p>
            ...
            <div class="card border-0 shadow-small mt-5 card-height2">
              <div class="card border-0 text-center">
                <div class="card-body">
                  ...
                  <p class="card-text">Le dernier drone grand public embl&eacute;matique de DJI.</p>
                </div>
              </div>
            </div>
          </div>
